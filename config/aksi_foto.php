...
if (isset($_POST['tambah'])) {
   ...
   echo "<script>alert('Selamat Data Berhasil Disimpan'); location.href='../admin/foto.php'</script>";
}
...
if (isset($_POST['edit'])) {
   ...
   echo "<script>alert('Selamat Data Berhasil Diperbaharui'); location.href='../admin/foto.php'</script>";
}
...
if (isset($_POST['hapus'])) {
   ...
   echo "<script>alert('Selamat Data Berhasil Dihapus'); location.href='../admin/foto.php'</script>";
}
