...
<body>
   <nav class="navbar navbar-expand-lg bg-body-secondary">
      <div class="container">
         ...
         <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
            ...
            <a href="../config/aksi_logout.php" class="btn btn-outline-danger m-1" name="logout">Keluar</a>
         </div>
      </div>
   </nav>
   ...
   <div class="container mt-3">
      ...
      Album : <?php $album = mysqli_query($koneksi, "SELECT * FROM album WHERE userid='$userid'");
                                    ...
                                    <div class="m-2">
                                       <div class="overflow-auto">
                                          <div class="sticky-top">
                                             ...
                                             <b>
                                                <p>Tanggal Uplod : <?php echo $data['tanggalunggah'] ?></p>
                                             </b>
