...
<body>
   ...
   <div class="container mt-3">
      <div class="row">
         <div class="col-md-4">
            <div class="card mt-2">
               <div class="card-header">Tambah Data Album</div>
               <div class="card-body">
         ...
         <div class="col-md-8">
            <div class="card mt-2">
               <div class="card-header">Detail Data Album</div>
               <div class="card-body">
                  <table class="table">
                     <thead>
                        <tr>
                                       ...
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             <form action="../config/aksi_album.php" method="POST">
                                                ...
                                                <label class="form-label">Nama Album</label>
                                                <input type="text" name="namaalbum" class="form-control" value="<?php echo $data['namaalbum'] ?>" required>
                                                <label class="form-label">Deskripsi</label>
                                    ...
                                    <div class="modal-dialog">
                                       <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                             <form action="../config/aksi_album.php" method="POST">
                                                <input type="hidden" name="albumid" value="<?php echo $data['albumid'] ?>">
                                                Apakah anda yakin ingin menghapus data album <b><?php echo $data['namaalbum'] ?></b>
